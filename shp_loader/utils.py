...
from shp_loader import ShpLoaderException
...
def get_default_user():
    ...
    if superusers.count() > 0:
        ...
        raise ShpLoaderException('You must have an admin account configured '
...
def upload(incoming, user=None, overwrite=False,
    ...
    """Upload a directory of spatial data files to GeoNode
       ...
       It catches ShpLoaderExceptions and gives a report per file
    """
    if verbosity > 1:
